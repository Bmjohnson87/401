...
# ssl for secure socket layer functionality, time for time-related functions, paramiko for SSH implementation, getpass for password input without echoing, and ZipFile for handling zip files
try:
...
# setting up SSL for HTTPS connections. It handles a compatibility issue with older versions of Python where _create_unverified_https_context might not be available
